    ...
    return {
        ...
        step() {
            ...
            switch (opcode) {
                ...
                case 0x34: // INC (HL)
                    tmp8 = mem.readb(fetchHL()) + 1;
                    mem.writeb(fetchHL(), tmp8);
                    setZ(!tmp8);
                    setN(0);
                    setH((tmp8 & 0xf) == 0);
                    break;
                ...
                case 0x70: // LD (HL), B
                    mem.writeb(fetchHL(), cpu.r.b);
                    break;

                case 0x71: // LD (HL), C
                    mem.writeb(fetchHL(), cpu.r.c);
                    break;

                case 0x72: // LD (HL), D
                    mem.writeb(fetchHL(), cpu.r.d);
                    break;

                case 0x73: // LD (HL), E
                    mem.writeb(fetchHL(), cpu.r.e);
                    break;

                case 0x74: // LD (HL), H
                    mem.writeb(fetchHL(), cpu.r.h);
                    break;

                case 0x75: // LD (HL), L
                    mem.writeb(fetchHL(), cpu.r.l);
                    break;
                ...
                case 0x86: // ADD (HL)
                    tmp32 = cpu.r.a + mem.readb(fetchHL());
                ...
                case 0xe2: // LD (FF00 + C), A
                    mem.writeb(0xff00 + cpu.r.c, cpu.r.a);
                    break;
                ...
                case 0xf2: // LD A, (FF00 + c)
                    cpu.r.a = mem.readb(0xff00 + cpu.r.c);
                    break;
